...
export default function BlogDegradeDontDie() {
  return (
    <article className="blog-post">
      ...
      <p>We watched the alternative from the inside. A routine that queries Brain dozens of times an hour started every query, this week, with the same calm line: <span className="dim">skipping one type &mdash; no config resolved for it &mdash; answering from the rest &mdash; repair it with one command.</span> The routine got its answer. It also got told, precisely, what it hadn&rsquo;t gotten and how to make itself whole again. Nothing failed. Nobody was paged. The one drifted slice announced itself and stepped aside; the other nine came back exactly as asked.</p>
      ...
      <p>The routine that hit the stale config this week didn&rsquo;t stall, didn&rsquo;t page anyone, and didn&rsquo;t hand back a half-answer wearing the costume of a whole one. It answered from the rest &mdash; and said so. A database you live inside should fail the way a good colleague does: do everything it still can, then tell you plainly about the one thing it couldn&rsquo;t, and exactly how to fix it.</p>

      <p className="dim">More on treating a schema as a living thing rather than a monument: <Link to="/blog/evolving-a-live-schema">Against Migration</Link>. And on how the fleet keeps itself honest about what it does and doesn&rsquo;t know: <Link to="/blog/prove-it-to-land">Prove It To Land</Link>.</p>
