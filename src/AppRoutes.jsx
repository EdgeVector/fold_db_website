...
import BlogTheEmergencyBecameTheSchedule from './pages/BlogTheEmergencyBecameTheSchedule';
...
export const PRERENDER_PATHS = [
  ...
  '/developer',
  '/blog',
  '/blog/the-emergency-became-the-schedule',
...
export default function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/blog/the-emergency-became-the-schedule" element={<BlogTheEmergencyBecameTheSchedule />} />
